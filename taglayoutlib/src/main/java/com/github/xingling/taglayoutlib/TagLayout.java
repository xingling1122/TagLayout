 ...
 */
public class TagLayout extends BaseTagLayout
    ...
    public interface OnTagClickListener {
        boolean onTagClick(View view, int position, BaseTagLayout parent);
    }
    ...
    public TagLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedMax = ta.getInt(R.styleable.TagLayout_max_select, -1);
        ta.recycle();
    }
